...
export default function TermsPage() {
  ...
  return <LegalPage eyebrow="Información legal" title="Términos de uso">
    ...
    <LegalSection title="3. Pago y garantía"><p>El precio, la moneda y los productos incluidos aparecen antes del pago. Todos los productos tienen 7 días de garantía. Las solicitudes deben enviarse respondiendo al correo de confirmación e incluyendo el correo y el identificador de la compra.</p></LegalSection>
