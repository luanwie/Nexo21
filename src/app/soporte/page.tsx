...
export default function SupportPage() {
  return <LegalPage eyebrow="Estamos para ayudarte" title="Soporte de Nexo 21">
    ...
    <LegalSection title="Tiempo de respuesta"><p>Respondemos en días hábiles. Mensajes repetidos sobre el mismo caso pueden retrasar la identificación; mantén la conversación en el mismo hilo.</p></LegalSection>
  </LegalPage>;
}
