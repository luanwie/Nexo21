...
export default function SupportPage() {
  ...
  return <LegalPage eyebrow="Estamos para ayudarte" title="Soporte de Nexo 21">
    ...
    <LegalSection title="Reembolso"><p>Todos los productos tienen una garantía de 7 días desde la compra. Solicita el reembolso respondiendo al comprobante dentro del plazo. Confirmaremos la recepción y el estado del pedido.</p></LegalSection>
